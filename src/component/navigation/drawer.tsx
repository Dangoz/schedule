    ...
    <>
      ...
      >
        <div className={DrawerStyle.wrapper}>
          <Menu
            className={DrawerStyle.menuWrapper}
          ...
          >
            ...
            <Menu.Item key="1" icon={<FolderOpenOutlined />} className={DrawerStyle.item}>
              <Link href="/archive">
                <div className={DrawerStyle.text}>Archive</div>
              </Link>
            </Menu.Item>
            ...
            <SubMenu key="sub1" title="Generation 1" className={DrawerStyle.subMenu}>
              <Menu onSelect={itemSelect} style={{ backgroundColor: theme.background, borderColor: theme.background }}>
                {g1talents.map((talent) => (
                  <Menu.Item
                    key={`${talent.name}`}
                    className={DrawerStyle.item}
                    icon={
                      <div className={DrawerStyle.photo}>
                        <img className={DrawerStyle.photoImg} src={`${talent.photo}`} />
                      </div>
                    }
                  >
                    <Link href={`/v/${talent.href}`}>
                      <div className={DrawerStyle.text}>{`${talent.name}`}</div>
                    </Link>
                  </Menu.Item>
                ))}
              </Menu>
            ...
            <Menu.Item key="99" icon={<HomeOutlined />} className={DrawerStyle.item}>
              <Link href="https://phase-connect.com">
                <div className={DrawerStyle.text}>Home Site</div>
              </Link>
            </Menu.Item>
          </Menu>
        </div>
